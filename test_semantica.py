...
def main():
    ...
    ref_path = "ref_data_pessoa.csv"
    new_path = "new_data_pessoa.csv"
    output_json = "transformed_data_pessoa.json"
    output_csv = "transformed_data_pessoa.csv"
    ...
    if ref_df == new_df:
        ...
        validated_data.to_csv("validate_data_pessoa.csv", index=False)
